...
#define SERVER_PORT "23944" // SERVERC_PORT, backend server C port
#define MAXBUFLEN 100    // udp
#define INPUT_FILE "block3.txt" // input txt file

using namespace std;

// reference Beej's book, mostly on the UDP listener part.
// get sockaddr, IPv4 or IPv6:
void *get_in_addr_serverC(struct sockaddr *sa)
{
...
int main(void)
{
    ...
    cout<< "The serverC is up and running using UDP on port " << SERVER_PORT << "." << endl;
    ...
    while(1){
        ...
        cout << "The ServerC finished sending response to the Main Server." << endl;
